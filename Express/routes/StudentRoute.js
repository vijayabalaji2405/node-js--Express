...
const DB_USER = "vjba2405";
const DB_USER_PASSWORD = "Balaji_2405";
const DB_URL = `mongodb+srv://${DB_USER}:${DB_USER_PASSWORD}@cluster0.gqgfw.mongodb.net/meetups?retryWrites=true&w=majority`;
